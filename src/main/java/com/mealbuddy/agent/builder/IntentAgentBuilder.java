...
public class IntentAgentBuilder {
    ...
    public IntentAgentBuilder(@Qualifier("MealbuddyLightChatModel") Model lightModel, PromptLoader promptLoader) {
    ...
    public ReActAgent build() {
        return ReActAgent.builder()
                ...
                .model(lightModel)
                .sysPrompt(promptLoader.load("mealbuddy/prompts/intent.txt"))
