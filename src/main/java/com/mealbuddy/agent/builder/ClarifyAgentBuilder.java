...
public class ClarifyAgentBuilder {
    ...
    public ClarifyAgentBuilder(@Qualifier("MealbuddyLightChatModel") Model lightModel, PromptLoader promptLoader) {
    ...
    public ReActAgent build() {
        return ReActAgent.builder()
                ...
                .model(lightModel)
                .sysPrompt(promptLoader.load("mealbuddy/prompts/clarify.txt"))
