...
public class RecommendResponseAgentBuilder {
    ...
    public RecommendResponseAgentBuilder(@Qualifier("MealbuddyMainChatModel") Model mainModel, PromptLoader promptLoader) {
    ...
    public ReActAgent build() {
        return ReActAgent.builder()
                ...
                .model(mainModel)
                .sysPrompt(promptLoader.load("mealbuddy/prompts/recommend-response.txt"))
