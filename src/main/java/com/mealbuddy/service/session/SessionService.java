...
import com.mealbuddy.model.SessionMessageRow;
import com.mealbuddy.model.SessionRow;
import com.mealbuddy.util.JsonService;
...
public class SessionService {
    ...
    /** 注入 IntentAgent 的最近对话条数上限，来自配置 mealbuddy.session.max-history-turns。 */
    ...
    public SessionService(
            ...
            @Value("${mealbuddy.session.max-history-turns:10}") int maxHistoryTurns
    ) {
