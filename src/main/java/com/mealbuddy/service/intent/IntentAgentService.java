package com.mealbuddy.service.intent;

import com.mealbuddy.agent.factory.AgentFactory;
import com.mealbuddy.model.ConversationTurn;
import com.mealbuddy.enums.Intent;
import com.mealbuddy.model.IntentResult;
import com.mealbuddy.model.SlotBundle;
import com.mealbuddy.service.slot.SlotOptionService;
import com.mealbuddy.service.trace.AgentTraceService;
import com.mealbuddy.util.LlmJsonService;
import com.mealbuddy.util.SlotJsonPicker;
...
public class IntentAgentService {
    ...
    /** IntentAgent 使用的轻量模型名，来自配置 mealbuddy.llm.light-model。 */
    ...
    public IntentAgentService(
            ...
            @Value("${mealbuddy.llm.light-model:qwen-turbo}") String modelName
    ) {
